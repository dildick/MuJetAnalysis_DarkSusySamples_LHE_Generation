...
filename = "../BRIDGE/DarkSUSY_mH_125_mGammaD_20000_14TeV_madgraph452_bridge224_events50k_v1.lhe"
f = open(filename, 'r')
...
if len(filename) == 77:
	...
	mass_GammaD = '20000'#filename[24:-42]
	energy = '14'#filename[29:-39]
	mass_Higgs = '125'#filename[12:-55]       
	mass_GammaD_Legend = '20.0'#filename[24:-45] + "." + filename[25:-42]
	lifetime_GammaD = "000"
